                      ...
                      <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition-colors">
                        ...
                        <td className="p-3 text-right">
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-orange-100 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200 text-[11px] font-bold transition-colors cursor-pointer"
                          >
                            Movimiento
                          </button>
                        </td>
